              ...
              <div className="c-InvestmentCard__inner">
                ...
                <div className="c-InvestmentCard__content">
                  ...
                  <p className="c-InvestmentCard--description js-split-description">
                    Quartlerly Report for General Partner and Asset Manager
                    produced using Yardi Systems' YSR technology.
                    <br />
                  </p>
                  <div className="c-InvestmentCard__content-header">
                    <h3 className="c-InvestmentCard--header">
                      Quarterly Report
                    </h3>
                    <a href={QReport} target="_blank" rel="noopener noreferrer">
                      Link to Document
                    </a>
                  </div>
                </div>
