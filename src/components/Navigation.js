...
const Navigation = () => (
  <header className="l-Header">
    <div className="l-Header--left">
      <a href="/" className="l-header__logo-wrap">
        <svg
          height="247pt"
    ...
    <div className="l-Header--right">
      <div className="menu-small-top-nav-container">
      ...
      <div className="c-MainMenu">
        <div className="MainMenuOverlay u-overlay"></div>
        <div className="c-MainMenu__panel scrollable">
          <div className="c-MainMenu__panel--header">
            <p className="u-CloseIconLink--close js-close-menu">
          ...
          <div className="c-MainMenu__panel--content">
            ...
            <div className="c-MainMenu__sub-links">
              <ul>
                <li>
                  <a className="js-hover-menu-img" href="contact/" data-img="">
                    Contact
                  </a>
                </li>
                <li>
